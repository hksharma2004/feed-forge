...
function TeamMemberAvatar({
  ...
  const isGitagent = member.image === "/icons/gitagent.png";
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={`size-24 4xl:size-40 rounded-2xl flex items-center justify-center border border-border bg-background/80 backdrop-blur-sm cursor-pointer shadow-sm ${
          isGitagent ? "p-2 4xl:p-3" : "p-5"
        }`}
      >
        <Image
          src={member.image}
